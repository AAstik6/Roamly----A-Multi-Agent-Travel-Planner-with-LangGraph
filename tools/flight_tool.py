...
# Default origin when the user says only destination eg: "Japan trip"
...
# tries to convert a country name (or text containing a country name) into its ISO 3166-1 alpha-2 country code
